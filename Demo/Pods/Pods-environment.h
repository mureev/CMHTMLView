...
// CMDataStorage
#define COCOAPODS_POD_AVAILABLE_CMDataStorage
#define COCOAPODS_VERSION_MAJOR_CMDataStorage 1
#define COCOAPODS_VERSION_MINOR_CMDataStorage 1
#define COCOAPODS_VERSION_PATCH_CMDataStorage 0
